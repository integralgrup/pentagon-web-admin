...
@section('content')
    <main class="main-field header-space corporate-page">
        ...
        <?php
            ...
            $breadcrumbImage = $about->banner_image ?? 'corporate-breadcrumb.jpg';
        ...
        <section class="breadcrumb relative w-full h-[400px] xl:h-[300px] md:h-[270px] sm:h-[220px]" id="breadcrumb">
            <div class="image-video relative pointer-events-none w-full h-full overflow-hidden">
                <?php if ($imageOrVideo == "image") { ?>
                    <img src="<?= asset( getFolder(['uploads_folder', 'images_folder'], app()->getLocale()) .'/' . $breadcrumbImage) ?>" alt="Kariyer" width="1785" height="400" class="w-full h-full object-cover">
                <?php } elseif ($imageOrVideo == "video") { ?>
                    <video autoplay loop muted playsinline class="w-full h-full object-cover">
                        <source srcset="<?= asset( getFolder(['uploads_folder', 'videos_folder'], app()->getLocale()) .'/' . $breadcrumbVideo) ?>" src="<?= asset( getFolder(['uploads_folder', 'videos_folder'], app()->getLocale()) .'/' . $breadcrumbVideo) ?>">
                    </video>
                <?php } ?>
