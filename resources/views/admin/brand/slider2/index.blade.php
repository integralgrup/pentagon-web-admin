                            ...
                            <tbody>
                                @foreach($sliders as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.brand.slider2.edit', [$id, $item->slider_id]) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.brand.slider2.destroy', [$id, $item->slider_id]) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
