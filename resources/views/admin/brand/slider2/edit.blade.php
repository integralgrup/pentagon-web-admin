...
@section('title', 'Marka Slider 2 Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Marka Slider 2 Güncelleme</h3></div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.brand.slider2.store', $brand_id[$item->lang]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.brand.slider2.index', $brand_id_1) }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
