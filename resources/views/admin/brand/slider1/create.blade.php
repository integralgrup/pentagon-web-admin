...
@section('title', 'Marka Slider 1 Ekleme')
...
<!--begin::App Content Header-->
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.brand.slider1.store', $id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="sort_{{ $language->lang_code }}" name="sort_{{ $language->lang_code }}" min="0">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
