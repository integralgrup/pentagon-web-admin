                                    ...
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($image[$language->lang_code])
                                                <img src="{{ asset( getFolder(['uploads_folder','blog_images_folder'], $language->lang_code) . '/' . $image[$language->lang_code]) }}" alt="{{ $alt[$language->lang_code] }}" style="width: 200px; height: auto; margin-top: 10px;">
