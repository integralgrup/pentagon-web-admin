...
@section('title', 'Hakkımızda(Üyelikler) Listesi')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Hakkımızda(Üyelikler) Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Hakkımızda(Üyelikler) Listesi</h5>
                            <a href="{{ route('admin.about.memberships.create') }}" class="btn btn-primary">
                            ...
                            <tbody class="connectedSortable"  table_name="about_memberships" column_name="content_id">
                                @foreach($membershipsContent as $item)
                                    <tr data-id="{{$item->content_id}}">
                                        ...
                                        <td>{{ $item->title }}</td>
                                        <td>
                                            <a href="{{ route('admin.about.memberships.edit', $item->content_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.about.memberships.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
