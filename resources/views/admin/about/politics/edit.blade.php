...
@section('title', 'Hakkımızda(Politikalarımız) Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Hakkımızda(Politikalarımız) Güncelleme</h3></div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    <?php 
                        foreach($politicsContent as $content){
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.about.politics.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.about.politics') }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
