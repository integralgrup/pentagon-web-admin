...
@section('title', 'Sektör Slider 2 Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Sektör Slider 2 Güncelleme</h3></div>
              <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.sector.slider2.store', $sector_id[$item->lang]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.sector.slider2.index', $id) }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
