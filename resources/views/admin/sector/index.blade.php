...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Sektör Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Sektör Listesi</h5>
                            <a href="{{ route('admin.sector.create') }}" class="btn btn-primary">
                                ...
                                @foreach($sectors as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.sector.destroy', $item->sector_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
