...
@section('title', 'Sektör Slider 1 Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Sektör Slider 1 Güncelleme</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                  <li class="breadcrumb item active" aria-current="page">Sektör Slider 1 Yönetimi</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                ...
                <div class="card">
                    ...
                    <?php 
                        foreach($sliders as $item){
                            $sector_id[$item->lang] = $item->sector_id;
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.sector.slider1.store', $sector_id[$item->lang]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($image[$language->lang_code])
                                                ...
                                                <input type="hidden" class="form-control" id="old_image_{{ $language->lang_code }}" name="old_image_{{ $language->lang_code }}" value="{{ $image[$language->lang_code] }}" readonly required >
                                            @endif
                                        </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.sector.slider1.index', $id) }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
