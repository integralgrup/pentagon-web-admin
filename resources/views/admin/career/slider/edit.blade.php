...
@section('title', 'Kariyer Slider Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Kariyer Slider Güncelleme</h3></div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.career.slider.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($image[$language->lang_code])
                                                <img src="{{ asset(getFolder(['uploads_folder','images_folder'], $language->lang_code) . '/' . $image[$language->lang_code]) }}" alt="{{ $alt[$language->lang_code] }}" style="width: 200px; height: auto; margin-top: 10px;">
