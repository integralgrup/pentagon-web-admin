                            ...
                            <div class="item relative w-full h-full">
                                <div class="image-wrapper w-full h-full pointer-events-none relative" data-swiper-parallax="50%">
                                    <div class="slider-image z-2 w-full h-full">
                                        <img src="<?= env('HTTP_DOMAIN') .'/'. getFolder(['uploads_folder','images_folder'], $item->lang) .'/'. $item->image ?>" lang="<?=$item->lang?>" alt="<?=$item->alt?>" width="1920" height="968" class="w-full h-full object-cover">
                                    </div>
