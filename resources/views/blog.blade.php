                ...
                <div class="reveal search md:col-span-2 sm:fixed sm:left-0 sm:bottom-0 sm:w-full sm:z-10 sm:bg-[#FCFBF7] transition-all duration-450 [&.search-invisible]:opacity-0 [&.search-invisible]:pointer-events-none" id="news-search-area">
                    <form action="#" method="post">
                        <div class="form-group relative min-w-[412px] lg:min-w-[300px]">
                            ...
                            <input type="search" name="search" id="search" placeholder="{{getStaticText(45)}}" class="peer w-full px-[35px] lg:px-[20px] py-[22px] xs:py-[10px] text-[17px] leading-normal tracking-[-0.17px] text-black placeholder:text-paragraph border border-solid border-black/8 transition-all duration-300 focus:border-black ">
